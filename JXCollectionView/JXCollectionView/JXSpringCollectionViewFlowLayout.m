...
//
//  JXSpringCollectionViewFlowLayout.m
//  JXCollectionView
//
...
#import "JXSpringCollectionViewFlowLayout.h"

@interface JXSpringCollectionViewFlowLayout ()
/** 强引用 */
@property (nonatomic,strong) UIDynamicAnimator * dynamicAnimator;
@end

@implementation JXSpringCollectionViewFlowLayout
- (instancetype)init {
    self = [super init];
    if (self) {
